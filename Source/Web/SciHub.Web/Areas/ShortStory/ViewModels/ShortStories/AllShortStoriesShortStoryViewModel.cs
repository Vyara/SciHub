namespace SciHub.Web.Areas.ShortStory.ViewModels.ShortStories
{
    ...
    public class AllShortStoriesShortStoryViewModel : IMapFrom<ShortStory>, IHaveCustomMappings
    {
        ...
        {
            configuration.CreateMap<ShortStory, AllShortStoriesShortStoryViewModel>()
